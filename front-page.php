    ...
    <div class="container hero-wrap">
      <div class="hero-copy">
        ...
        <div class="hero-actions">
          <a class="btn primary" href="contatti.html">Prenota una consulenza</a>
      ...
      <aside class="hero-media" aria-label="Immagine e punti chiave">
        <div class="img">
          <img src="assets/img/hero-photo.svg" alt="Illustrazione: nutrizione e piatto bilanciato" />
        </div>
        <div class="facts">
  ...
  <main class="container">
    ...
    <div class="grid" aria-label="Ultimi articoli">
      <a class="card" href="post-plate-method.html" aria-label="Apri articolo: Il Plate Method: comporre un pasto equilibrato">
  <div class="feature">
    <img src="assets/posts/plate-method.svg" alt="Immagine in evidenza: Il Plate Method: comporre un pasto equilibrato" />
...
<a class="card" href="post-spuntini-intelligenti.html" aria-label="Apri articolo: Spuntini intelligenti: 10 idee pratiche">
  <div class="feature">
    <img src="assets/posts/spuntini-intelligenti.svg" alt="Immagine in evidenza: Spuntini intelligenti: 10 idee pratiche" />
...
<a class="card" href="post-idratazione.html" aria-label="Apri articolo: Idratazione: quanta acqua serve davvero?">
  <div class="feature">
    <img src="assets/posts/idratazione.svg" alt="Immagine in evidenza: Idratazione: quanta acqua serve davvero?" />
  ...
  <div class="container">
    <div class="small">
      <strong>Studio di Nutrizione (demo)</strong> — Via della Salute 10, 00100 Roma · Tel. +39 06 9876 5432 ·
      <a href="mailto:info@studionutrizione.it">info@studionutrizione.it</a>
    </div>
    <div class="small muted" style="margin-top:8px">
      © 2026 Dott.ssa Sofia Rinaldi. Tutti i diritti riservati.
    </div>
  </div>
</footer>
</body>
